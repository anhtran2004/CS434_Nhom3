<%@ Page Title="Hồ Sơ Thành Viên" Language="C#" MasterPageFile="~/WebForm/User/User.Master" AutoEventWireup="true" CodeBehind="thanhvien.aspx.cs" Inherits="Webebook.WebForm.User.thanhvien" %>
        ...
        <asp:Panel ID="pnlMemberProfile" runat="server" Visible="false">
         ...
         <div class="text-center mt-8">
             ...
             <span class="mx-2 text-gray-300">|</span>
              <asp:HyperLink ID="hlHome" runat="server" NavigateUrl="~/WebForm/User/usertrangchu.aspx" CssClass="text-sm text-blue-600 hover:text-blue-800 hover:underline">
